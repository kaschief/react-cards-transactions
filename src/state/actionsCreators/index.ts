...
export const selectCard = (id: string): Action => {
  return { type: ActionType.SELECT_CARD, payload: id };
};

export const setTransactions = (transactions: Transactions): Action => {
  return { type: ActionType.SET_TRANSACTIONS, payload: transactions };
};

export const setActiveTransactionsId = (id: string): Action => {
  return { type: ActionType.SET_ACTIVE_TRANSACTIONS_ID, payload: id };
};
...
export const setIsFiltered = (filtered: boolean): Action => {
  return { type: ActionType.SET_IS_FILTERED, payload: filtered };
};

export const setFilterTerm = (filterTerm: string): Action => {
  return { type: ActionType.SET_FILTER_TERM, payload: filterTerm };
};
